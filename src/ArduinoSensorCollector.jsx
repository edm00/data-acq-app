...
//           // addLog(`Raw data received: ${value}`);
...
//     const values = cleanData.split(',').filter(val => val !== '');
...
//     // Expecting 10 values: sensor1-8, temperature, humidity
//     if (values.length === 10 || values.length === 8) {
//       const newData = {
...
//       addLog(`Invalid data format. Expected 10 values, got ${values.length}: ${cleanData}`);
//     }
//   };
...
//   // Replace the useEffect that initializes datasets
// useEffect(() => {
//   const datasets = [
...
//   //     borderWidth: 2,
//   //     pointRadius: 2,
//   //     yAxisID: index >= 8 ? 'y1' : 'y' // Temperature and Humidity on right axis
//   //   }));
...
//         setRecordedData(prev => [...prev, dataEntry]);
//         addLog(`Recorded: T=${sensorData.temperature}°C, H=${sensorData.humidity}%`);
//       } else {
//         addLog(`Live: ${sensorData}`);
//       }
...
//       // Update chart with all sensor values
//       const timestamp = new Date().toLocaleTimeString();
//       const sensorValues = [
...
//       setChartData(prev => {
//         const newLabels = [...prev.labels.slice(-49), timestamp];
//         const newDatasets = prev.datasets.map((dataset, index) => ({
//           ...dataset,
//           data: [...dataset.data.slice(-49), sensorValues[index]]
//         }));
...
//       //   setRecordedData(prev => [...prev, dataEntry]);
//       //   addLog(`Recorded: T=${newData.temperature}°C, H=${newData.humidity}%`);
//       // } else {
//       //   addLog(`Live: T=${newData.temperature}°C, H=${newData.humidity}%`);
//       // }
//     } else if (values.length > 0) {
//       addLog(`Invalid data format. Expected 10 values, got ${values.length}`);
//     }
//   };
...
//     // Reset chart data but keep datasets structure
//     setChartData(prev => ({
//       labels: [],
...
//       stopRecording();
//       addLog('Auto-stop: Recording duration completed');
//       downloadCSV(); // Auto download after duration
//     }, settings.duration * 60 * 1000);
//   };
...
//   //     title: {
//   //       display: true,
//   //       text: 'All Sensor Values Over Time'
//   //     },
//   //   },
//   //   elements: {
//   //     point: {
...
//   //   }
//   // };
//   // Replace the chartOptions constant
// // Replace the chartOptions constant
// const chartOptions = {
//   responsive: true,
//   maintainAspectRatio: false,
